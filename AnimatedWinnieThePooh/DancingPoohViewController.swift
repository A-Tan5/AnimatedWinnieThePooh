//
//  DancingPoohViewController.swift
...
class DancingPoohViewController: UIViewController {
    ...
    @IBOutlet weak var DancingPoohView: UIView!
    @IBOutlet var backgroundView: UIView!
    
    func DancingPooh(){
        let view = DancingPoohView
    ...
    func animateKey(){
        UIView.animateKeyframes(withDuration: 6, delay: 0, options: [.repeat, .calculationModePaced ], animations: {
            
            UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: -50, y: 0).rotated(by: CGFloat.pi / 8).scaledBy(x: 0.66, y: 0.66)
                self.backgroundView.backgroundColor = UIColor.green
            })

            UIView.addKeyframe(withRelativeStartTime: 0.05, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: 50, y: 0).rotated(by: -CGFloat.pi / 8).scaledBy(x: 1, y: 1)
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.1, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: -50, y: 0).rotated(by: CGFloat.pi / 8).scaledBy(x: 1.5, y: 1.5)
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.2, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: 0, y: 0).rotated(by: CGFloat.pi / 8)
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.25, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform(translationX: -50, y: 0)
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.35, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform(translationX: 0, y: 0)
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.4, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform(rotationAngle:  CGFloat.pi / 8)
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.65, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: -50, y: 0).rotated(by: CGFloat.pi / 8).scaledBy(x: 1, y: 1)
                self.backgroundView.backgroundColor = UIColor.red
            })
            ...
            UIView.addKeyframe(withRelativeStartTime: 0.8, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: 50, y: 0).rotated(by: CGFloat.pi / 2).scaledBy(x: 1.5, y: 1.5)
                self.backgroundView.backgroundColor = UIColor.brown
            })
            
            UIView.addKeyframe(withRelativeStartTime: 0.85, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: -50, y: 0).rotated(by: CGFloat.pi ).scaledBy(x: 1, y: 1)
                self.backgroundView.backgroundColor = UIColor.gray
            })
            
            UIView.addKeyframe(withRelativeStartTime: 0.9, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: 50, y: 0).rotated(by: CGFloat.pi * 1.5 ).scaledBy(x: 0.66, y: 0.66)
                self.backgroundView.backgroundColor = UIColor.purple
            })
            
            UIView.addKeyframe(withRelativeStartTime: 0.95, relativeDuration: 0.05, animations: {
                self.DancingPoohView.transform = CGAffineTransform.identity.translatedBy(x: 0, y: 0).rotated(by: CGFloat.pi * 2).scaledBy(x: 1, y: 1)
                self.backgroundView.backgroundColor = UIColor.systemBackground
            })
